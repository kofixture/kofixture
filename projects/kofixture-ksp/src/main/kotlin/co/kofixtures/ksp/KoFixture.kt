...
/**
 * Marks an `object` declaration as the source of a KSP-generated [co.kofixtures.core.FixtureModule].
 *
 ...
 * property plus typed [co.kofixtures.core.OverrideScope] extension members for each type found.
 *
 * Example:
 * ```kotlin
 ...
 * ```
 *
 * @see co.kofixtures.core.FixtureModule
 */
