...
import co.kofixtures.ksp.generator.FixtureModuleGenerator
import co.kofixtures.ksp.generator.OverrideScopeGenerator
    ...
    private fun writeGeneratedFile(
        ...
        file.bufferedWriter().use { writer ->
            ...
            if (classesWithParams.isNotEmpty()) {
                writer.write("import co.kofixtures.core.OverrideScope\n")
                writer.write("import co.kofixtures.core.FixtureOverride\n")
                writer.write("import co.kofixtures.core.NamedOverrideKey\n")
                writer.write("import kotlin.random.Random\n")
            }
            if (classesWithParams.isNotEmpty() && hasArb) {
                writer.write("import io.kotest.property.Arb\n")
                writer.write("import co.kofixtures.kotest.arb.ArbGenerator\n")
            }
            writer.write("\n")
